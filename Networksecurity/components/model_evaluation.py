...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            # Loading Trained Model and Checking Existing Model
            train_model_file_path = self.model_trainer_artifact.trained_model_file_path
            model_resolver = ModelResolver()

            is_model_accepted = True
            
            # If no existing model, save the current model as the best model
            ...
            # Comparing New Model with Existing Model
            # Load the latest model and compare metrics
            ...
            # Evaluating Improved Accuracy and Acceptance 
